...
namespace BXRenderPipeline
{
    ...
    class BXVolumeComponentProvider : IProvider
    {
        ...
        BXRenderSettingsVolume m_Target;
        BXRenderSettingsVolumeInspector m_TargetEditor;

        public BXVolumeComponentProvider(BXRenderSettingsVolume target, BXRenderSettingsVolumeInspector targetEditor)
        {
            m_Target = target;
