...
namespace BXGeometryGraph.Runtime
{
    ...
    public class GeometryRenderer : MonoBehaviour
    {
        ...
        private void PopulateInstanceDataBuffer()
        {
            ...
            m_InstanceData.SetData(objectToWorld, 0, (int)(byteAddressObjectToWorld / kSizeOfPackedMatrix), kNumInstances);
            m_InstanceData.SetData(worldToObject, 0, (int)(byteAddressWorldToObject / kSizeOfPackedMatrix), kNumInstances);
