...
using UnityEditor;
using UnityEngine;
using static BXGeometryGraph.SerializationHelper;
...
namespace BXGeometryGraph
{
    ...
    /// <see cref="GeometrySubGraphImporter.GatherDependenciesFromSourceFile"/> and
    /// <see cref="GeometrySubGraphImporter.OnImportAsset"/>. The latter must always import fully, but for the former we
    ...
    class MinimalGraphData
    {
        ...
        [SerializeField]
        List<JSONSerializedElement> m_SerializableNodes = new List<JSONSerializedElement>();
