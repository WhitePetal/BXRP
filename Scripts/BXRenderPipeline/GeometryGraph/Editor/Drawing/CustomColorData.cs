...
namespace BXGeometryGraph
{
    ...
    {
        private Dictionary<string, Color> m_CustomColors = new Dictionary<string, Color>();
        [SerializeField]
        private List<SerializationHelper.JSONSerializedElement> m_SerializableColors = new List<SerializationHelper.JSONSerializedElement>();
