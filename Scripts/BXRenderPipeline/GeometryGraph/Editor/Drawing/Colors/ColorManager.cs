...
namespace BXGeometryGraph
{
    ...
    class ColorManager
    {
        ...
        public void SetNodesDirty(IEnumerable<IGeometryNodeView> nodeViews)
        {
        ...
        public void SetActiveProvider(int newIndex, IEnumerable<IGeometryNodeView> nodeViews)
        {
        ...
        public void UpdateNodeViews(IEnumerable<IGeometryNodeView> nodeViews)
        {
            foreach (var view in nodeViews)
            {
                UpdateNodeView(view);
        ...
        public void UpdateNodeView(IGeometryNodeView nodeView)
        {
