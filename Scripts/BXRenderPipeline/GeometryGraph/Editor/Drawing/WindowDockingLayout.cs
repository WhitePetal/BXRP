...
namespace BXGeometryGraph
{
	...
	public class WindowDockingLayout
	{
		...
		{
			Vector2 layoutCenter = new Vector2(layout.x + layout.width * 0.5f, layout.y + layout.height * 0.5f);
		...
		public void ClampToParentWindow()
		{
			...
			m_VerticalOffset = Math.Max(0f, m_VerticalOffset);
		}
