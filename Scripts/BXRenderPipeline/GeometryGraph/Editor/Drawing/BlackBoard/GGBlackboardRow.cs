...
{
    class GGBlackboardRow : VisualElement, IDisposable
    {
        static readonly string k_UxmlTemplatePath = "UXML/Blackboard/GGBlackboardRow";
        ...
        public GGBlackboardRow(VisualElement item, VisualElement propertyView)
        {
