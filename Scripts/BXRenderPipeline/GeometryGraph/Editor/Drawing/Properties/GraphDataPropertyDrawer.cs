...
{
    [GGPropertyDrawer(typeof(GraphData))]
    public class GraphDataPropertyDrawer : IPropertyDrawer
    {
        ...
        Dictionary<AbstractGeometryGraphDataExtension, bool> m_SubDataFoldouts = new Dictionary<AbstractGeometryGraphDataExtension, bool>();
        ...
        VisualElement GetSettings(GraphData graphData, Action onChange)
        {
            ...
            // Data Extensions
            var validExtensions = AbstractGeometryGraphDataExtension.ValidExtensions();
            if (validExtensions.Count() > 0 || graphData.SubDatas.Count() > 0)
            {
                ...
                var extensionList = new ReorderableListView<JsonData<AbstractGeometryGraphDataExtension>>(
