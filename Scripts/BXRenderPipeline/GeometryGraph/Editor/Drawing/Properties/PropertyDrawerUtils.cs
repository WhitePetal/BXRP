...
namespace BXGeometryGraph
{
    public static class PropertyDrawerUtils
    {
        ...
        internal static void AddDefaultNodeProperties(VisualElement parentElement, AbstractGeometryNode node, Action setNodesAsDirtyCallback, Action updateNodeViewsCallback)
        {
            ...
            if (node.canSetPrecision)
            {
                ...
                if (node is MultiJsonInternal.UnknownNodeType)
        ...
        internal static void AddCustomCheckboxProperty(
            VisualElement parentElement, AbstractGeometryNode node,
