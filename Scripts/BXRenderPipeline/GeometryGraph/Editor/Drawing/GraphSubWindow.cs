...
namespace BXGeometryGraph
{
    ...
    class GraphSubWindow : GraphElement, IGGResizable
    {
        IGGViewModel m_ViewModel;

        IGGViewModel ViewModel
        {
            get => m_ViewModel;
        ...
        public virtual string layoutKey => "BXGeometryGraph.SubWindow";
        ...
        public List<ISelectable> selection
        {
            get
            {
                ...
                throw new AssertionException("GraphSubWindow was unable to find a selection provider. Please check if parent view of: " + name + " implements ISelectionProvider::GetSelection", null);
        ...
        protected GraphSubWindow(IGGViewModel viewModel)
        {
            ViewModel = viewModel;
