...
{
    [Serializable]
    public abstract class AbstractGeometryProperty : GeometryInput
    {
        public abstract PropertyType propertyType { get; }

        internal override ConcreteSlotValueType concreteGeometryValueType => propertyType.ToConcreteGeometryValueType();
        ...
        public virtual string GetPropertyTypeString()
        {
            ...
            if (ggVersion < latestVersion)
                typeString = $"{typeString} (Legacy v{ggVersion})";
            return typeString;
        }
    }

    [System.Serializable]
    public abstract class AbstractGeometryProperty<T> : AbstractGeometryProperty
    {
        [SerializeField]
        private T m_Value;
    ...
    // class for extracting deprecated data from older versions of AbstractGeometryProperty
    class LegacyShaderPropertyData
    {
        ...
        public static void UpgradeToHLSLDeclarationOverride(string json, AbstractGeometryProperty property)
        {
