...
{
    [System.Serializable]
    public abstract class AbstractGeometryProperty<T> : IGeometryProperty
    {
        [SerializeField]
        private T m_Value;
        ...
        public abstract PreviewProperty GetPreviewGeometryProperty();

        public abstract INode ToConcreteNode();

        public abstract IGeometryProperty Copy();
    }
}
