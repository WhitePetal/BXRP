    ...
    internal static class NodeClassCache
    {
        ...
        private class PostProcessor : AssetPostprocessor
        {
            static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
            {
                ...
                {
                    if (str.EndsWith(GeometrySubGraphImporter.Extension))
                    {
        ...
        public static IEnumerable<ContextFilterableAttribute> GetFilterableAttributesOnNodeType(Type nodeType)
        {
            ...
            {
                throw new ArgumentException($"The passed in Type {nodeType.FullName} was not found in the loaded assemblies as a child class of AbstractGeometryNode");
            }
        }
        ...
        private static void EnsureKnownTypeLookupTable()
        {
            if (m_KnownTypeLookupTable == null)
            {
                ...
                foreach (Type nodeType in TypeCache.GetTypesDerivedFrom<AbstractGeometryNode>())
                {
