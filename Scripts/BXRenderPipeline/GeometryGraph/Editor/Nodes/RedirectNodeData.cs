...
{
    class RedirectNodeData : AbstractGeometryNode
    {
        ...
        void AddSlots(ConcreteSlotValueType edgeType)
        {
            ...
            switch (edgeType)
            {
                ...
                case ConcreteSlotValueType.Vector1:
                    AddSlot(new DynamicVectorGeometrySlot(kInputSlotID, "", "", SlotType.Input, Vector4.zero));
                    AddSlot(new DynamicVectorGeometrySlot(kOutputSlotID, "", "", SlotType.Output, Vector4.zero));
                    break;
                ...
                case ConcreteSlotValueType.Geometry:
                    AddSlot(new GeometryGeometrySlot(kInputSlotID, "", "", SlotType.Input));
                    AddSlot(new GeometryGeometrySlot(kOutputSlotID, "", "", SlotType.Output));
                    break;
                default:
        ...
        {
            var inputSlot = FindSlot<GeometrySlot>(kInputSlotID);
            ...
            var outputSlot = FindSlot<GeometrySlot>(kOutputSlotID);
        ...
        public override void ValidateNode()
        {
            ...
            var slots = new List<GeometrySlot>();
            ...
            {
                owner.AddValidationError(objectId, "Node has no inputs and default value will be 0.", GeometryCompilerMessageSeverity.Warning);
            }
        }
    }
}
