    ...
    static class MultiJsonInternal
    {
        public class UnknownJsonObject : JsonObject
        {
            ...
            public override T CastTo<T>()
            {
                ...
                else if (t == typeof(GeometryInput) || t.IsSubclassOf(typeof(GeometryInput)))
                {
                    UnknownGeometryPropertyType usp = new UnknownGeometryPropertyType(typeInfo, jsonData);
        ...
        internal class UnknownGeometryPropertyType : AbstractGeometryProperty
        {
            public string jsonData;

            public UnknownGeometryPropertyType(string displayName, string jsonData) : base()
            {
                this.displayName = displayName;
                this.jsonData = jsonData;
            }
            ...
            internal override AbstractGeometryNode ToConcreteNode() { return null; }
        ...
        internal class UnknownNodeType : AbstractGeometryNode
        {
            public string jsonData;
            ...
            {
                base.ValidateNode();
                owner.AddValidationError(objectId, "This node type could not be found. No function will be generated in the geometry.", GeometryCompilerMessageSeverity.Warning);
            }
        ...
        private static FieldInfo s_ObjectIdField = typeof(JsonObject).GetField("m_ObjectId", BindingFlags.Instance | BindingFlags.NonPublic);
