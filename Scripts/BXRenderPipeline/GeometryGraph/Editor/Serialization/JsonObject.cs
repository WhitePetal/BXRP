...
namespace BXGeometryGraph
{
    ...
    public class JsonObject : ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        protected int m_GGVersion = 0;
        public virtual int ggVersion { get => m_GGVersion; protected set => m_GGVersion = value; }
        ...
        internal void ChangeVersion(int newVersion)
        {
            ...
            ggVersion = newVersion;
            onAfterVersionChange?.Invoke();
        }

        public JsonObject()
        {
            ggVersion = latestVersion;
        }
        ...
        [SerializeField]
        private string m_ObjectId = Guid.NewGuid().ToString("N");
