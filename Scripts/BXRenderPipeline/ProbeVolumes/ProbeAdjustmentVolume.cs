...
namespace BXRenderPipeline
{
	...
	public class ProbeAdjustmentVolume : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		public enum Mode
        {
			...
			OverrideSampleCount,
			/// <summary>
            /// the rendering layer masks for the probes within the adjustment volume
            /// </summary>
            ...
            /// </summary>
			IntensityScale = 99, // make sure this apperas last
        }
		...
		public enum RenderingLayerMaskOperation
        {
			...
			Add,
			/// <summary>
            /// Removes a rendering laye to the probes within the adjustment volume
            /// </summary>
			Remove
        }

		/// <summary>
        /// what to do with probes falling inside this volume
        /// </summary>
