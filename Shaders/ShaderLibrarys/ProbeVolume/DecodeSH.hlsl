...
#define APV_L1_ENCODING_SCALE 2.0 // Should be: 3/(2*sqrt(3)) * 2, but rounding to 2 to issues wr are abserving
...
void DecodeSH_L2(inout half3 l0, inout half4 l2_R, inout half4 l2_G, inout half4 l2_B, inout half4 l2_C)
{
    ...
    DecodeSH_L2(l0, l2_R, l2_G, l2_B, outL2_C);
    l2_C = half4(outL2_C, 0);
}

float3 EncodeSH(float l0, float3 l1)
{
    return l0 == 0.0f ? 0.5f : 1l * rcp(l0) / (2.0f * APV_L1_ENCODING_SCALE) + 0.5f;
}
...
void EncodeSH_L2(inout half3 l0, inout half4 l2_R, inout half4 l2_G, inout half4 l2_B, inout half3 l2_C)
{
    // Account for how L2 is encoded.
    l2_R.z /= 3.0;
    l2_G.z /= 3.0;
    ...
    half3 rcpl0 = rcp(l0);
    rcpl0 = half3(l0.x == 0.0 ? 0.0 : rcpl0.x, l0.y == 0.0 ?  0.0 : rcpl0.y, l0.z == 0.0 ? 0.0 : rcpl0.z);

    l2_R = 0.5 + l2_R * rcp(APV_L2_ENCODING_SCALE) * rcpl0.r;
    l2_G = 0.5 + l2_G * rcp(APV_L2_ENCODING_SCALE) * rcpl0.g;
    l2_B = 0.5 + l2_B * rcp(APV_L2_ENCODING_SCALE) * rcpl0.b;
    l2_C = 0.5 + l2_C * rcp(APV_L2_ENCODING_SCALE) * rcpl0;
}
#endif
