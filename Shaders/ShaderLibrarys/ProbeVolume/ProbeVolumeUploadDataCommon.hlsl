#ifndef PROBE_VOLUME_UPLOAD_DATA_COMMON_INCLUDE
#define PROBE_VOLUME_UPLOAD_DATA_COMMON_INCLUDE

#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/Common.hlsl"
#include "ProbeVolume.hlsl"
#include "Assets/Scripts/BXRenderPipeline/ProbeVolumes/ProbeReferenceVolume.Streaming.cs.hlsl"
...
void getProbeLocationAndOffsets(uint chunkIndex, uint chunkProbeIndex, out float3 baseProbe, out float3 loc, out float3 probe1Offset, out float3 probe2Offset, out float3 probe3Offset)
{
    ...
    uint3 dstChunk = _ScratchBuffer.Load4(chunkIndex * 16).xyz; // *16 because 4 int (4*4 => 16byte) per chunk
